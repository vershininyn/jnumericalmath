package dev.projects.math.jnummath.jnumoptimization.local.unconstrained.zeroorder;
...
import dev.projects.math.jnummath.jnumoptimization.unconstrained.local.algorithms.zeroorder.impl.learning.orthogonal.ZeroOrderLearningOrthogonalUnconstrainedOptimizationAlgorithm;
...
import dev.projects.math.jnummath.jnumoptimization.unconstrained.local.directionsearch.zeroorder.impl.learning.orthogonal.ZeroOrderOrthogonalDirectionSearchAlgorithm;
...
import dev.projects.math.jnummath.jnumoptimization.unconstrained.local.linearsearch.zeroorder.impl.learning.ZeroOrderLearningRandomLinearSearchAlgorithm;
...
public class ZeroOrderLearningOrthogonalUnconstrainedOptimizationAlgorithmTests {
    ...
    @Test
    public void zeroOrderLearningOrthogonalUnconstrainedOptimizationAlgorithmTest()   {

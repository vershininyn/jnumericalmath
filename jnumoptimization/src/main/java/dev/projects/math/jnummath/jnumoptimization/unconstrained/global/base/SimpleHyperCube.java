...
public class SimpleHyperCube implements ICloneable<SimpleHyperCube> {
    ...
    public static SimpleHyperCube getInstance(double edgeLength, DenseVector center)   {
    ...
    public SimpleHyperCube(DenseVector alpha, DenseVector beta)   {
        if ((alpha == null)
                || (beta == null)
    ...
    @Override
    public SimpleHyperCube deepCopy()   {

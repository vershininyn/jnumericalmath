...
import dev.projects.math.jnummath.jnumoptimization.unconstrained.local.algorithms.zeroorder.base.AbstractZeroOrderUnconstrainedOptimizationAlgorithm;
...
import dev.projects.math.jnummath.jnumoptimization.unconstrained.local.linearsearch.zeroorder.impl.learning.ZeroOrderLearningLinearSearchAlgorithmStateDto;
                ...
                implements IZeroOrderLearningOrthogonalUnconstrainedOptimizationAlgorithm
{
    ...
    @Override
    public void initializeOptimizationProcess(IScalarFunction function)   {
    ...
    protected void doOptimizationCycle()   {
        ...
        int variablesCount = fun.getInputDimensionSize();

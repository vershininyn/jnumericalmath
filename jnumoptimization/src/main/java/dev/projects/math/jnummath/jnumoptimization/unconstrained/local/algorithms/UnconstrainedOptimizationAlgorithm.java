...
public abstract class UnconstrainedOptimizationAlgorithm<TFunction extends IScalarFunction,
    ...
    public void setCriticalOptimizationAttributes(TCriticalOptimizationAttributes attributes)   {
        if (attributes == null) throw new LoggableException("Unacceptable attributes");

        criticalOptimizationAttributes = attributes;
    }

    public void setLinearSearchAlgorithm(TLinearSearchAlgorithm lsAlgorithm)   {
        if (lsAlgorithm != null) {
            lsAlgorithm.reset();
        }
    ...
    public void setDirectionSearchAlgorithm(TDirectionSearchAlgorithm dsAlgorithm)   {
        if (dsAlgorithm != null) {
            dsAlgorithm.reset();
        }
    ...
    public TOptimizationResults minimize()   {
    ...
    public void initializeOptimizationProcess(TFunction function)   {

    }

    public void deinitializedOptimizationProcess()   {
    }

    public abstract TOptimizationResults getOptimizationResults(int actualIterationCount, Duration period)  ;
    ...
    protected abstract boolean checkOtherCondition()  ;

    protected abstract DenseVector computeDelta(int actualIterationCount)  ;
    ...
    protected boolean checkFunctionOutput(TFunction function, TCriticalOptimizationAttributes attributes)   {
    ...
    private void checkRepeatedFunctionComputeCountTimes()   {
        TFunction fun = getFunction();
    ...
    private boolean checkRepeatedFunctionOutput(TFunction fun, TCriticalOptimizationAttributes attrb)   {

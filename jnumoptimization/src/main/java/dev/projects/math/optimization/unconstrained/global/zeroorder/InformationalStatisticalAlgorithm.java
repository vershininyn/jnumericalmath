...
public class InformationalStatisticalAlgorithm implements IZeroOrderLinearSearchAlgorithm {
    ...
    public InformationalStatisticalAlgorithm(double RConstant, double Epsilon) throws LoggableException {
    ...
    public void setLeftAndRigth(double leftA, double rigthB) throws LoggableException{

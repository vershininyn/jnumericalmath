...
import dev.projects.math.optimization.unconstrained.local.algorithms.interpolation.impl.LearningCubicStepInterpolationAlgorithm;
...
public class LearningFirstOrderLinearSearchAlgorithm implements IFirstOrderLearningLinearSearchAlgorithm {
    ...
    public LearningFirstOrderLinearSearchAlgorithm(ICubicInterpolationAlgorithm interpolationAlg,
                                                   ...
                                                   double hmaxStep,
                                                   double qMax,
                                                   double qMin) throws LoggableException {
    ...
    public static IFirstOrderLearningLinearSearchAlgorithm getStandartSet(double hMax,
                                                                          double qMin,
                                                                          double qMax) throws LoggableException {
    ...
    @Override
    public IFirstOrderLearningLinearSearchAlgorithm setGammaOptimalParameters(FirstOrderLearningLinearSearchOptimalParametersDTO gammaDTOObj) throws LoggableException {
    ...
    public void initializeProcess(IScalarDifferentiableFunction function) throws LoggableException {
        setOptimalVariables(Double.MAX_VALUE, Double.MAX_VALUE, DenseVector.getInstance(function.getVariablesCount(), Double.MAX_VALUE));
        correctionGrad = DenseVector.getInstance(function.getVariablesCount(), 0.0);
    }
    ...
    @Override
    public ILinearSearchAlgorithm<IScalarDifferentiableFunction> deepCopy() throws LoggableException {

package dev.projects.math.optimization.unconstrained.local.directionsearch.firstorder.impl.learning.spacetension.operators.impl.idc;
...
public class KachmazhInternalDirectionCorrectionOperator
    ...
    @Override
    public ISpaceTensionInternalDirectionCorrectionOperator deepCopy() throws LoggableException {

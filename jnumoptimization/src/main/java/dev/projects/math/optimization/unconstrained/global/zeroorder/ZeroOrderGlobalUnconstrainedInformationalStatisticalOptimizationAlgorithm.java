package dev.projects.math.optimization.unconstrained.global.zeroorder;
        ...
        implements IZeroOrderGlobalUnconstrainedInformationalStatisticalOptimizationAlgorithm
{
    ...
    @Override
    public void setOriginalCube(SimpleHyperCube cube) throws LoggableException {
    ...
    private void divideOptimalHyperCubeIntoThreeSubHyperCubes(SimpleHyperCube optHyperCube,
                                                              DenseVector uPoint,
                                                              DenseVector vPoint) throws LoggableException {
    ...
    private double computeFunctionOutput(DenseVector point) throws LoggableException {
        return (testingMap.get(point) == null) ? (getFunction().computeOutput(point)) : (testingMap.get(point));
    }

    private double computeLipschitzConstant(DenseVector alphaPoint, DenseVector betaPoint) throws LoggableException {
    ...
    private DenseVector[] generateUAndVPoints(SimpleHyperCube currentOptimalCube) throws LoggableException {
        ...
        for(int index= 0; index < fun.getVariablesCount(); index++) {
    ...
    private SimpleHyperCube computeRParameterAtSearchAreaAndReturnOptCube(double globalLipschitzConstant) throws LoggableException {
    ...
    private double computeRParameter(double mu, SimpleHyperCube cube) throws LoggableException {

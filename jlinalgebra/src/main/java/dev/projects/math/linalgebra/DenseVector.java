...
public class DenseVector extends DMatrixRMaj implements DMatrix, ICloneable<DenseVector>, ICountable {
    ...
    public static DenseVector getInstance(int size) throws LoggableException {
        if (size <= 0) {
    ...
    public static DenseVector getInstance(double[] data) throws LoggableException {
        if (data == null) {
    ...
    public static DenseVector getInstance(DenseVector vector) throws LoggableException {
    ...
    public static DenseVector getInstance(int size, double value) throws LoggableException {
        if (size <= 0) {
    ...
    public static DenseVector getInstance(List<Double> data) throws LoggableException {
    ...
    public static DenseVector getRandomizedVector(int length, double scalFactor) throws LoggableException {
        if (length <= 0) {
    ...
    public DenseVector shiftByCoefficient(double coeff) throws LoggableException {
    ...
    public DenseMatrix multiplyByVector(DenseVector vector) throws LoggableException {
    ...
    public DenseVector add(DenseVector vector) throws LoggableException {
    ...
    public DenseVector add(double coeff, DenseVector vector) throws LoggableException {
        if ((vector == null) || (!checkOtherVector(vector))) {
            throw new LoggableException("Unacceptable matrix");
        }
    ...
    public DenseVector substract(DenseVector vector) throws LoggableException {
        if ((vector == null) || (!checkOtherVector(vector))) {
            throw new LoggableException("Unacceptable matrix");
        }
    ...
    public DenseVector substract(double pCoeff, DenseVector vector) throws LoggableException {
        if ((vector == null) || (!checkOtherVector(vector))) {
            throw new LoggableException("Unacceptable matrix");
        }
    ...
    public double getInnerProduct(DenseVector vector) throws LoggableException {
        if ((vector == null) || !checkOtherVector(vector)) {
            throw new LoggableException("Unacceptable vector");
        }
    ...
    public DenseVector extendByVector(DenseVector vector) throws LoggableException {
        if ((vector == null) || (vector.getSize() == 0)) throw new LoggableException("Unacceptable vector");

        return extendByArray(vector.getData());
    }

    public DenseVector extendByDouble(double value) throws LoggableException {
        return extendByArray(new double[]{value});
    }

    public DenseVector extendByArray(double[] array) throws LoggableException {
    ...
    public DenseVector[] splitMiddleToLeftAtIndex(int index) throws LoggableException {
        return splitAtIndex(index, true);
    }

    public DenseVector[] splitMiddleToRigthAtIndex(int index) throws LoggableException {
        return splitAtIndex(index, false);
    }

    public DenseVector[] splitAtIndex(int index, boolean middleToLeft) throws LoggableException {

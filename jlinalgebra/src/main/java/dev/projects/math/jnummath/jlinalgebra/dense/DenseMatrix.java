...
public class DenseMatrix extends DMatrixRMaj implements DMatrix, ICloneable<DenseMatrix>, ICountable {
    public static DenseMatrix getInstance(int rowCount, int columnCount)   {
    ...
    public static DenseMatrix getInstance(double[] pData, int rowCount, int columnCount)   {
        if (pData == null) {
    ...
    public static DenseMatrix getInstance(final DenseMatrix matrix)   {
        if ((matrix == null)
    ...
    public static DenseMatrix getDiagonal(double[] diagonal)   {
    ...
    public static DenseMatrix getDiagonal(int rowCount, int columnCount, double diagonalValue)   {
        if ((rowCount <= 0) || (columnCount <= 0)) {
            throw new LoggableException("Unacceptable row/column count");
        }
    ...
    public static DenseMatrix getUnit(int rowCount, int columnCount)   {
        return getDiagonal(rowCount, columnCount, 1.0);
    }

    public static DenseMatrix getSquareUnit(int pWidth)   {
    ...
    public OrthogonalTransformationResultDto doOrthogonalTransformationAtPlace(DenseVector y, DenseVector sum)   {
    ...
    public DenseMatrix setDiagonal(DenseVector vector)   {
    ...
    public DenseMatrix multiplyRowByCoefficient(int row, double coefficient)   {
    ...
    public DenseMatrix multiplyColumnByCoefficient(int column, double coefficient)   {
    ...
    public DenseVector refreshableMultiply(double epsilon, double multiplicator, DenseVector vector)   {
        if (epsilon <= 0.0) {
    ...
    public DenseVector multiplyByVector(DenseVector vector)   {
    ...
    public DenseMatrix multiplyByMatrix(DenseMatrix matrix)   {
    ...
    public DenseMatrix add(double coeff, DenseMatrix matrix)   {
        if ((matrix == null) || (!checkOtherMatrix(matrix))) {
            throw new LoggableException("Unacceptable matrix");
        }
    ...
    public DenseMatrix substract(DenseMatrix matrix)   {
        if ((matrix == null) || (!checkOtherMatrix(matrix))) {
            throw new LoggableException("Unacceptable matrix");
        }

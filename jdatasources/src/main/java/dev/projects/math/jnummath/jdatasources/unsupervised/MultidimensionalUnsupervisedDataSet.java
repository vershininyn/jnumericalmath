package dev.projects.math.jnummath.jdatasources.unsupervised;
...
public class MultidimensionalUnsupervisedDataSet
     ...
     * @
     */
    public MultidimensionalUnsupervisedDataSet[] splitByRows(float sampleCoeff)   {
     ...
     * @
     */
    public OneDimensionalUnsupervisedDataSet sliceToOneDimension(int index)   {
